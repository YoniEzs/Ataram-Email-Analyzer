...
const I18N_TRANSLATIONS = {
    he: {
        ...
        'Supports .eml and .msg files (max 50MB)': 'נתמכים קבצי ‎.eml ו-‎.msg (עד 50MB)',
        ...
        'SPF, DKIM, and DMARC verification': 'אימות SPF, DKIM ו-DMARC',
        'URLs & Links': 'קישורים',
        ...
        'All analysis is performed securely. Email content is never stored.': 'הניתוח מתבצע באופן מאובטח. תוכן המייל אינו נשמר.',
        ...
        'APPEARS LEGITIMATE - Standard security measures apply': 'נראה תקין — נהלי אבטחה רגילים חלים',
    }
};
